...
def test_housing_gradientboostedtree():
    ...
    np.testing.assert_allclose(
        p[:10],
        [
            8592267.945129, 10237830.012832,  9640255.985793, 10180136.420183, 8935277.254079,  9116677.826144, 10391172.19137 ,  7823996.050055,  9012873.652479,  7790072.066678
        ],
        # rtol=1e-2,
    )
