...
def test_housing_gradientboostedtree():
    ...
    np.testing.assert_allclose(
        p[:10],
        [
            10153886.825137, 10228043.358084,  9250209.100109,  9625320.38567 ,  8441615.154178, 10046719.36346 , 11027888.728298,  9269609.157115, 8175317.976215,  7653074.341622
        ],
        #rtol=0.3,
    )
